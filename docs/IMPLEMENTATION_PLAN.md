...
- ⬜ TODO — сам Google Drive OAuth (можно переиспользовать Google Cloud проект из YouTube-задачи, добавить drive.readonly scope). **Это может сделать только владелец.**
